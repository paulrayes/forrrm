	...
	return React.createClass({
		...
		render: function render() {
			...
			if (this.props.multiline) {
				...
				input = <input type={this.props.type || 'text'} name={name} id={name} value={this.props.value} placeholder={this.props.placeholder} disabled={this.props.disabled} readOnly={this.props.readOnly} onChange={this.onChange} onFocus={this.onFocus} onBlur={this.onBlur} ref="input" />;
			}
			return (
